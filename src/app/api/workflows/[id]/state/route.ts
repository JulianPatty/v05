...
const EdgeSchema = z.object({
  ...
  labelStyle: z.record(z.string(),z.string()).optional(),
  labelShowBg: z.boolean().optional(),
  labelBgStyle: z.record(z.string(),z.string()).optional(),
...
const LoopSchema = z.object({
  ...
  forEachItems: z.union([z.array(z.string()), z.record(z.string(),z.string()), z.string()]).optional(),
})

const ParallelSchema = z.object({
  id: z.string(),
  nodes: z.array(z.string()),
  distribution: z.union([z.array(z.string()), z.record(z.string(),z.string()), z.string()]).optional(),
  count: z.number().optional(),
...
const WorkflowStateSchema = z.object({
  ...
  deployedAt: z.date().optional(),
  deploymentStatuses: z.record(z.string(),DeploymentStatusSchema).optional(),
...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    if (error instanceof z.ZodError) {
      ...
      return NextResponse.json(
        { error: 'Invalid state data', details: error.message },
        { status: 400 }
      )
    }
