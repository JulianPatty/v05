...
export default {
  /**
   * @description
   * Use 'class' strategy for dark mode. This enables toggling dark mode via a 'dark' class on the root element.
   * See: https://tailwindcss.com/docs/dark-mode#class-strategy
   */
  darkMode: 'class',
  content: [
