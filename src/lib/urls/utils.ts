 ...
 * @returns The domain with port if applicable (e.g., 'localhost:3000' or 'Setn.ai')
 */
export function getBaseDomain(): string {
  try {
    ...
    try {
      ...
      return isProd ? 'Setn.ai' : 'localhost:3000'
    }
  }
}
 ...
 * @returns The email domain (e.g., 'Setn.ai' instead of 'www.Setn.ai')
 */
