<p align="center">
  <img src="app/sim/public/static/sim.png" alt="Sim Studio Logo" width="500"/>
</p>
...
<p align="center">
  <img src="app/sim/public/static/demo.gif" alt="Sim Studio Demo" width="800"/>
</p>
...
```bash
./app/sim/scripts/ollama_docker.sh pull <model_name>
```
...
Realtime socket server (from `app/sim` directory in a separate terminal):
```bash
cd app/sim
bun run dev:sockets
```
...
<p align="center">Made with ❤️ by the Setn Team</p>